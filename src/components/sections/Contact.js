...
function Contact() {
    ...
    return (_jsxs("section", { id: "contact", className: "py-24 md:py-32", children: [_jsx(ToastContainer, { position: "top-right", hideProgressBar: false }), _jsxs("div", { className: "container max-w-3xl mx-auto px-6", children: [_jsx(Reveal, { as: "h2", variant: "slide-up", className: "text-3xl md:text-4xl font-bold mb-8 text-center", children: "Connect With Me" }), _jsx(MotionReveal, { variant: "fade", className: "mb-10", children: _jsxs("div", { className: "grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6", children: [_jsxs("div", { className: "bg-white dark:bg-neutral-900 shadow-lg rounded-xl px-6 py-4 flex items-center gap-3 border border-neutral-200 dark:border-neutral-700 w-full", children: [_jsx("span", { className: "font-semibold text-neutral-700 dark:text-neutral-200", children: "Email:" }), _jsx("a", { href: "mailto:ganeshrodge25@gmail.com", className: "text-fuchsia-600 dark:text-violet-400 font-medium break-words", children: "ganeshrodge25@gmail.com" })] }), _jsxs("div", { className: "bg-white dark:bg-neutral-900 shadow-lg rounded-xl px-6 py-4 flex items-center gap-3 border border-neutral-200 dark:border-neutral-700 w-full", children: [_jsx("span", { className: "font-semibold text-neutral-700 dark:text-neutral-200", children: "Phone:" }), _jsx("a", { href: "tel:+919665552822", className: "text-fuchsia-600 dark:text-violet-400 font-medium break-words", children: "+91 9665552822" })] })] }) }), _jsx(MotionReveal, { variant: "up", className: "mt-10 space-y-6", children: _jsx("form", { onSubmit: handleFormSubmit, children: _jsxs("div", { className: "space-y-6", children: [_jsx(MotionReveal, { variant: "right", children: _jsx(FloatingInput, { label: "Name", value: values.name, error: errors.name, onChange: (e) => setValues((v) => (Object.assign(Object.assign({}, v), { name: e.target.value }))) }) }), _jsxs(MotionReveal, { variant: "left", delay: 60, children: [_jsx(FloatingInput, { label: "Email", type: "email", value: values.email, error: errors.email, onChange: (e) => setValues((v) => (Object.assign(Object.assign({}, v), { email: e.target.value }))) }), _jsx(ValidationError, { prefix: "Email", field: "email", errors: formState.errors })] }), _jsx(MotionReveal, { variant: "right", delay: 120, children: _jsx(FloatingInput, { label: "Phone", type: "tel", value: values.phone, error: errors.phone, onChange: (e) => setValues((v) => (Object.assign(Object.assign({}, v), { phone: e.target.value }))) }) }), _jsxs(MotionReveal, { variant: "up", delay: 180, children: [_jsx(FloatingTextarea, { label: "Message", value: values.message, error: errors.message, onChange: (e) => setValues((v) => (Object.assign(Object.assign({}, v), { message: e.target.value }))) }), _jsx(ValidationError, { prefix: "Message", field: "message", errors: formState.errors })] }), _jsx(MotionReveal, { variant: "zoom", delay: 240, children: _jsx(motion.button, { whileTap: { scale: 0.98 }, disabled: sending || formState.submitting, className: "px-6 py-3 rounded-full bg-gradient-to-r from-fuchsia-500 to-violet-500 text-white font-semibold shadow-md hover:shadow-lg transition-all disabled:opacity-60 cursor-pointer hover:from-fuchsia-400", children: sending || formState.submitting ? "Sending…" : "Send Message" }) })] }) }) })] })] }));
}
